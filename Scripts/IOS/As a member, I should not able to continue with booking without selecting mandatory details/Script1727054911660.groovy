...
Mobile.verifyElementVisible(findTestObject('ios/Book Appointment/errortxt_Please_Clickon_Available_Date'), 0)
...
Mobile.verifyElementVisible(findTestObject('ios/Book Appointment/errorTxt_TimeSlot'), 5)
