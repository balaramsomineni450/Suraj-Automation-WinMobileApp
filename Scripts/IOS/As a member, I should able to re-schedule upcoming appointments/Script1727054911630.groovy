...
Mobile.tap(findTestObject('IOS/Home/upcoming_Appointment'), 15)
...
Mobile.verifyElementVisible(findTestObject('IOS/Book Appointment/successTxt_AppointmentBooked'), 10)
