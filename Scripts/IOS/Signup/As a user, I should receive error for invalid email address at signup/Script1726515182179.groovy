...
Mobile.setText(findTestObject('IOS/Signup/emailAddress'), 'test1gmail.com', 0)
...
Mobile.tap(findTestObject('IOS/Signup/button_Next'), 5)

Mobile.verifyElementVisible(findTestObject('IOS/Signup/errortxt_InvalidEmail'), 0)
