...
Mobile.tap(findTestObject('IOS/Signup/Sponsor Company/button_GetStarted'), 0)

Mobile.setText(findTestObject('IOS/Signup/Enroll Program/input_MemberID'), MemberID, 0)

Mobile.tap(findTestObject('IOS/Signup/Enroll Program/contract'), 0)

Mobile.tap(findTestObject('IOS/Signup/Enroll Program/button_Done'), 0)

Mobile.tap(findTestObject('IOS/Signup/Enroll Program/button_Okay'), 0)

Mobile.verifyElementVisible(findTestObject('IOS/Signup/Enroll Program/successTxt_Registration'), 0)
