...
Mobile.tap(findTestObject('IOS/Benefits/Treatment Cost Estimator/text_IVF'), 0)
...
Mobile.tap(findTestObject('IOS/Benefits/Treatment Cost Estimator/button_Submit'), 0)

Mobile.verifyElementExist(findTestObject('IOS/Benefits/Treatment Cost Estimator/text_TreatmentCostEstimator'), 5)
