...
AlreadySelectedProvider = Mobile.getText(findTestObject('IOS/Benefits/Treatment Cost Estimator/text_SelectedProvider'), 
    0)

Mobile.tap(findTestObject('IOS/Benefits/Treatment Cost Estimator/select_Provider'), 0)
...
Mobile.verifyNotMatch(AlreadySelectedProvider, Mobile.getText(findTestObject('IOS/Benefits/Treatment Cost Estimator/text_SelectedProvider'), 
        0), false)
