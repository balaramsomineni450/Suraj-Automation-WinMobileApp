...
Mobile.setText(findTestObject('IOS/Reset Password/input_ConfirmPassword'), NewPassword, 0)

Mobile.tap(findTestObject('IOS/Reset Password/button_Submit'), 0)

Mobile.verifyElementVisible(findTestObject('IOS/Reset Password/errorTxt_PasswordLengthFormat'), 0, FailureHandling.CONTINUE_ON_FAILURE)
