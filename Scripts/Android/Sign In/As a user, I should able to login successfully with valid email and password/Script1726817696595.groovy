...
Mobile.tap(findTestObject('Android/Signin/android.widget.TextView - Skip'), 5, FailureHandling.OPTIONAL)
...
Mobile.verifyElementNotVisible(findTestObject('Android/Signin/createNewAccount'), 15)
