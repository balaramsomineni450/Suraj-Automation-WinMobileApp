...
Mobile.tap(findTestObject('Android/Benefits/Treatment Cost Etimator/Select_Provider'), 2)
...
Mobile.tap(findTestObject('Android/Benefits/Treatment Cost Etimator/txt_KofinasFertilityGroup'), 0)
...
Mobile.tap(findTestObject('Android/Benefits/Treatment Cost Etimator/txt_IVF'), 0)
...
Mobile.verifyElementExist(findTestObject('Android/Benefits/Treatment Cost Etimator/txt_TreatmentCostEstimator'), 0)
