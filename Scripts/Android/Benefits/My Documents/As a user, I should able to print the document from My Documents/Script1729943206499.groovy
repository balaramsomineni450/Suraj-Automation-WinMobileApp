...
Mobile.tap(findTestObject('Android/Benefits/My Documents/button_Print'), 0)

Mobile.verifyElementVisible(findTestObject('Android/Benefits/My Documents/printPreview'), 5)
