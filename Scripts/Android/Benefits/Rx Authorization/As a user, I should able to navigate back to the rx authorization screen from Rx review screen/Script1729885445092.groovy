...
Mobile.tap(findTestObject('Android/Benefits/Rx Authorization/back'), 0)

Mobile.verifyElementExist(findTestObject('Android/Benefits/Rx Authorization/text_RXAuthorization'), 0)
