...
if (Mobile.verifyElementVisible(findTestObject('Android/Benefits/Rx Authorization/text_RXReview'), 0, FailureHandling.OPTIONAL)) {
    ...
    Mobile.tap(findTestObject('Android/Benefits/Rx Authorization/button_PickBestPharmacy'), 0)

    Mobile.tap(findTestObject('Android/Benefits/Rx Authorization/button_Yes'), 0)

    Mobile.tap(findTestObject('Android/Benefits/Rx Authorization/dropdown_Pharmacy'), 0)

    Mobile.tap(findTestObject('Android/Benefits/Rx Authorization/option_Alliance Rx Walgreens Prime'), 0)

    Mobile.verifyElementVisible(findTestObject('Android/Benefits/Rx Authorization/pharmacy_AllianceRXWalgreensPrime'), 0)

    Mobile.tap(findTestObject('Android/Benefits/Rx Authorization/button_PickBestPharmacy'), 0)

    Mobile.verifyElementVisible(findTestObject('Android/Benefits/Rx Authorization/text_SeletedBestPharmcy'), 0)
} else {
    KeywordUtil.markFailed('RX with Pended status doesn\'t found')
}
