...
Mobile.tap(findTestObject('Android/Benefits/txt_KofinasFertilityGroup'), 0)

Mobile.tap(findTestObject('Android/Benefits/back'), 0)

Mobile.tap(findTestObject('Android/Benefits/back'), 0)

Mobile.tap(findTestObject('Android/Benefits/txt_FET'), 0)
...
Mobile.tap(findTestObject('Android/Benefits/button_Submit'), 0)

Mobile.verifyElementExist(findTestObject('Android/Benefits/txt_TreatmentCostEstimator'), 0)
