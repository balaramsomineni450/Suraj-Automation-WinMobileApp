...
Mobile.tap(findTestObject('Android/Signup/EnrollProgram/button_Next'), 5)

Mobile.verifyElementVisible(findTestObject('Android/Signup/EnrollProgram/successTxt_Registration'), 10)
